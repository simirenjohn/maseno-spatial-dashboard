...
import { HelpCircle, Search, Filter, MapPin, Layers, Navigation, MousePointer } from 'lucide-react';
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from '@/components/ui/dialog';

const STORAGE_KEY = 'maseno-guide-seen';

const steps = [
  { icon: Search, title: 'Search', desc: 'Type a building, lab, hostel, or lecture room name (e.g. "MLH 2", "NL 5") in the search bar. Search is case-insensitive and includes rooms inside multi-storey buildings.' },
  ...
  { icon: MapPin, title: 'Basemap', desc: 'Switch between OpenStreetMap and Satellite imagery using the buttons on the top-right of the map.' },
  { icon: Navigation, title: 'Directions', desc: 'Use "Get Directions" in the sidebar to plot a route. Enable location for accurate positioning.' },
];
